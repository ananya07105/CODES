    ...
    add.citizenship,&add.phone,add.acc_type,&add.amt,&add.deposit.month,&add.deposit.day,&add.deposit.year)!=EOF)
    {
        ...
        {   test=1;
            ...
            if(choice==1)
                ...
                upd.address,add.citizenship,add.phone,add.acc_type,add.amt,add.deposit.month,
            ...
            fprintf(newrec,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d\n",
            add.acc_no,add.name,add.dob.month,add.dob.day,add.dob.year,add.age,
            add.address,add.citizenship,add.phone,add.acc_type,add.amt,add.deposit.month,add.deposit.day,add.deposit.year);
    }
    fclose(old);
    fclose(newrec);
    remove("record.dat");
    ...
    {   printf("Enter the name:");
        ...
        &add.amt,&add.deposit.month,&add.deposit.day,&add.deposit.year)!=EOF)
        {
            ...
            {   system("cls");
                ...
                printf("\nAccount No.:%d\nName:%s \nDOB:%d/%d/%d \nAge:%d ");
                printf("\nAddress:%s \nCitizenship No:%s \nPhone number:%.0lf \nType Of Account:%s \nAmount deposited:$%.2f \nDate Of Deposit:%d/%d/%d\n\n",add.acc_no,add.name,
                 add.dob.month,add.dob.day,add.dob.year,add.age,add.address,
